This script compiles all the individual csvs once downloaded from AGOL. 

# Data Prep
After downloading the data from AGOL, you end up four individual .csv docs for each survey layer; 
...
full <- full_join(dat2, avid, by = c("mGlobID" = "aGUID"), keep = T) # joining avidity
```
