...
ggplot() +
  ...
  scale_fill_manual(values=c("seagreen", "light blue", "pink", "grey", "khaki", "light green", "purple"))

ggsave(paste(rumPlots, "Esp_HabitatMap.png", sep='/'), width = 8, height = 4)
```

## Extracting Depth
```{r Extracting Depth}
# Adding depth
Bathy <- raster(paste(r.dir, "espBathy.tif", sep = '/'))
crs(Bathy)  #4326
