...
# Making bbox
StudySite = st_as_sfc(st_bbox(c(xmin = 121.5, xmax = 123, ymax = -33.4, ymin = -34.5), crs = 4283))
st_write(StudySite, paste(s.dir, "StudySite.gpkg", sep = '/'), append = F)

# Cropping coast to study site
SC <- st_crop(spCoast, StudySite)
# SC <- st_union(NWS)
st_write(SC, paste(s.dir, "EspCoast.gpkg", sep = '/'), append = F)
