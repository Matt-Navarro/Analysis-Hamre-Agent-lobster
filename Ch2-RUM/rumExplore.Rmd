...
* Read elith paper and Matts paper on BRTs

* Finish documentation for annual report

* Finish draft of methods

* Add plots to general summaries

Variables to fix
* KDE fishing pressure
* Add number of boats in 5km within a day
* Side - need to go beyond boat ramps and do it spatial 
* Site type - consider how you can isolate shore based activities from boat based activities - do you need a shore grid??
* Agreement is incorrect - how to isolate those that have agreed 
* local avidity - nTimes24months
* Species - make species suites
* Avidity variables
* BoatType

Model 
* Add fisher ID and Julian Day as random effects/startfified
* Get offset to wokr in gbm.step
