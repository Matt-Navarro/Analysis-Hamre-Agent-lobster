...
#### Fishing Type ####
unique(DPrum$FishingType)
unique(DPrum$FishingType_other)
unique(DPrum$jFishingType)
...
unique(DPrum$exStop)
unique(DPrum$FishingType_other)
which(DPrum$FishingType_other =="Coral trout fly island ")
which(colnames(DPrum)=="Species")
DPrum[1270, 7] # BR
DPrum[1270, 20] # FishingTYoe
DPrum[1353, 17] #Long
DPrum[1353, 18] #Lat
DPrum[733, 8] # site
DPrum[1353, 26] # MaxHook
DPrum[1353, 32] #
names(DPrum)
unique(DPrum$BaitLure)
```